...
import loginSuccess from "../ui/login-form-success";
import { 
...
export default function Form (){
    ...
    const initialState:State = {message:null,validationErrors:{},error:null};
    const [state,formAction] = useFormState(createUserAccount,initialState)

    // if successful account created display email verification message and login button
    if(state?.message != null){
        loginSuccess(state.message)
    }
